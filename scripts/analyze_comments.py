...
CURATED = {
    ...
    # --- Scanned-PDF comments recovered via OCR (2026-07-24) ---
    "FAA-2026-4558-0592": ("utility_water_energy", "support_with_changes", ["Largest VA drinking water utility backs keeping water/wastewater/dam sectors UAFR-eligible", "Recommends a 100,000-population-served threshold for expedited/automatic approval, aligned to EPA size classes", "Wants bundled/system-wide applications for geographically distributed multi-facility systems"]),
    "FAA-2026-4558-0559": ("public_safety", "support_with_changes", ["LAPD says plain-text Remote ID is spoofable; wants a verifiable cryptographic standard (e.g. DRIP) phased in after a 5-year transition", "Urges lateral boundary be allowed to extend beyond the property line case-by-case, since aerial threats don't respect parcel lines", "Recommends identity-verified (e.g. Login.gov) accounts for the UAFR notification portal"]),
    "FAA-2026-4558-0576": ("government_agency", "support_with_changes", ["Cleveland Metroparks says the commercial-facility 2.5M-annual-visitor threshold excludes comparable high-traffic parks/zoos; recommends lowering to 1M", "Argues the ticketing/entry-control eligibility requirement is irrelevant to UAS risk and excludes open-access sites like beaches", "Wants dam eligibility keyed to hazard classification (high-hazard-potential dams) rather than power/output/water-delivery thresholds", "Wants GSFS eligibility extended to state/local government facilities, not just national-security-designated ones"]),

    # --- Batch reviewed 2026-07-27: 27 of 30 unreviewed org filings ---
    # (FAA-2026-4558-0568, -0603, -1148 remain unreviewed: regulations.gov only
    # returned a title-stub for the inline comment and the PDF attachment text
    # was never extracted/OCR'd — needs a re-run of fetch_comments.py.)
    "FAA-2026-4558-0573": ("trade_association", "support", ["Represents 178,000 cattle producers across 44 state affiliates", "Frames farm operations as curtilage deserving 4th Amendment protection from warrantless aerial surveillance", "Drone-enabled activism increasingly used to target farms for trespassing, biosecurity, and operational-security threats"]),
    "FAA-2026-4558-0567": ("trade_association", "support_with_changes", ["Extend UAFR eligibility to FAA-licensed spaceports and private space infrastructure regardless of location", "Spaceports currently limited to temporary TFRs during active operations only, unlike airports/military sites", "Remote, sparsely monitored sites hold high-value hardware and hazardous cryogenic/hypergolic propellants"]),
    "FAA-2026-4558-0566": ("trade_association", "support_with_changes", ["Amend § 74.250(a)(2) so it doesn't forbid legitimate non-transitory construction drone use (mapping, surveys, inspections) within a UAFR", "Establish project-based or recurring authorizations instead of per-flight approval for contractors", "Require using agencies to publish accessible points of contact and disclose existing UAFRs to contractors during bidding"]),
    "FAA-2026-4558-0569": ("trade_association", "support", ["Represents packers/processors of the majority of U.S. meat and poultry", "Activists increasingly incorporate drones into campaigns targeting livestock/food operations; inspectors can't distinguish threat from legitimate flight in real time", "Urges FAA to move expeditiously toward finalizing and implementing the rule"]),
    "FAA-2026-4558-0570": ("trade_association", "support", ["Represents Texas/Oklahoma/New Mexico feedyards producing over 25% of the nation's fed beef supply", "Drones continue flying over feedyards despite an existing Texas state law restricting it", "Startled cattle risk injury to themselves and to feedyard employees"]),
    "FAA-2026-4558-0565": ("trade_association", "support", ["Strongly supports the rule as a necessary, overdue protection for the food supply and farm biosecurity", "Focuses FAA's attention on documented biosecurity, worker-safety, and physical-security threats from low-altitude drone activity at swine operations"]),
    "FAA-2026-4558-0560": ("utility_water_energy", "support_with_changes", ["Recommends a community-level SLTT application process so small/medium water utilities can share Remote ID sensing costs", "Allow a single consolidated application to cover multiple non-contiguous facilities under common utility ownership", "Proposes a utility self-designation framework built on existing AWIA risk assessments rather than FAA pre-approval", "Protect UAFR application data from FOIA/public disclosure, consistent with AWIA treatment of risk assessments"]),
    "FAA-2026-4558-0582": ("public_safety", "support_with_changes", ["Requests FAA expand Healthcare and Public Health Sector eligibility to cover pharmaceutical R&D and manufacturing facilities", "Suggests FAA consider UAFR variants that prohibit loitering while still permitting flyovers"]),
    "FAA-2026-4558-0585": ("utility_water_energy", "support_with_changes", ["Reports repeated unauthorized drone filming of dam gate/structural details publicly posted online, framing it as a CEII-relevant security gap with no current legal remedy", "Recommends eligibility explicitly cover hydroelectric facilities of all sizes, including smaller legacy dams", "Recommends treating UAFR application/petition materials consistent with Critical Energy Infrastructure Information confidentiality protections"]),
    "FAA-2026-4558-0593": ("critical_infrastructure_owner", "support_with_changes", ["Represents fertilizer manufacturing/storage/distribution facilities handling toxic-inhalation-hazard chemicals like anhydrous ammonia", "Wants lateral boundaries set by facility-specific risk analysis rather than fixed to the property line, since a TIH release can extend past the fence line", "Opposes publishing a public UAFR notice/inventory that could function as a target list of protected facilities", "Requests a streamlined fast-track Standard UAFR pathway and clearer Remote ID receiver performance standards"]),
    "FAA-2026-4558-0595": ("drone_company", "support_with_changes", ["Distinguish operators merely transiting a UAFR from those with legitimate operational need to remain within it for inspections/surveys", "Adopt a standing 'whitelist' approval process for trusted recurring operators instead of per-flight notification", "Reiterate that a UAFR is not itself authority for private parties to interdict, disable, or interfere with unmanned aircraft"]),
    "FAA-2026-4558-0591": ("trade_association", "support_with_changes", ["Warns drones can act as biosecurity fomites and can flush wild waterfowl (HPAI/Newcastle vectors) into contact with flocks", "Requests explicit critical-infrastructure status for egg-laying, broiler, and turkey facilities", "Proposes a 400-ft buffer and operator exceptions limited to farm owner, contracted operators, or emergency responders"]),
    "FAA-2026-4558-0594": ("individual_part107_operator", "oppose", ["Part 107 sUAS operator and retired Air Force pilot argues the rule won't deter 'bad actors' who already ignore FAA/gun-law-style regulations", "Argues FAA already lacks FSDO staffing/enforcement capacity to administer a new layer of UAS rules", "Publishing UAFR boundaries on public maps (e.g., FAA UAS Data on a Map) signals to bad actors where something critical is located"]),
    "FAA-2026-4558-0599": ("trade_association", "support", ["Arizona dairy cooperative supports the rule for animal welfare, biosecurity, employee safety, and business-continuity reasons", "Distinguishes legitimate ag drone use (crop/precision agriculture) from unauthorized, unconsented surveillance of dairy operations"]),
    "FAA-2026-4558-0609": ("individual_other", "oppose", ["Opposes the rule as risking a broad, expanding patchwork of no-fly zones across 16 CI sectors without proof existing tools (Remote ID, Part 107, TFRs, penalties) are insufficient", "Warns restrictions could reduce independent oversight/journalism documenting pollution, animal welfare, and industrial conditions at affected facilities", "Urges a high evidentiary standard, narrow tailoring, periodic review, and automatic expiration for any UAFR"]),
    "FAA-2026-4558-0610": ("individual_part107_operator", "support_with_changes", ["Small UAS business founder published a reconstruction of 21,765 FAA UAS Sighting Reports (2014-2026) finding no significant 11-year national trend", "Argues operator/registration density near a facility is not valid hazard evidence, citing a negative correlation in his analysis", "Recommends adjudicating 'aviation safety necessity' on site-specific evidence and weighing the burden on low-risk small operators"]),
    "FAA-2026-4558-0613": ("drone_company", "support_with_changes", ["BVLOS critical-infrastructure-inspection operator supports risk-based, facility-specific eligibility and property-boundary-limited UAFRs", "Recommends an automated, standing notification process for recurring BVLOS operations rather than per-flight notice", "Requests an FAA-managed whitelist so facilities can programmatically distinguish authorized from unknown aircraft", "Requests clearer eligibility criteria and process detail for Special UAFR designations"]),
    "FAA-2026-4558-0772": ("other", "oppose", ["Animal-welfare advocacy group argues there's no documented evidence of drone safety/security threats at food and ag facilities, only documented evidence of drone footage exposing violations", "Urges FAA not to create food-and-agriculture sector gating criteria eligible for UAFRs", "Frames aerial photojournalism as one of the last tools for the public to see inside industrial ag facilities"]),
    "FAA-2026-4558-0931": ("individual_part107_operator", "support_with_changes", ["Recommends case-by-case coordination between client, drone service provider, UAFR registrant, and FAA when a job site falls inside a UAFR", "Proposes periodic (6-month) audits of whether a UAFR is still necessary"]),
    "FAA-2026-4558-1027": ("trade_association", "support_with_changes", ["Standards body notes the NPRM requires Remote ID detection receivers but cites no consensus standard for specifying/procuring/verifying compliant detection equipment", "Recommends FAA reference ASTM F3411-22a (Remote ID technical spec) and F3586-22 (Remote ID means-of-compliance) as a recognized technical baseline", "Offers ASTM Committee F38 on UAS as a technical resource to FAA during rulemaking"]),
    "FAA-2026-4558-1143": ("media_photography", "oppose", ["Opposes the food and agriculture industry obtaining UAFRs, arguing it would shield potential animal-welfare abuses from documentation", "Frames drone photojournalism as an important tool for exposing harm to animals"]),
    "FAA-2026-4558-1128": ("individual_other", "oppose", ["Opposes any UAFR bans near sites already subject to federal, state, or local compliance obligations", "Argues lack of enforcement/oversight lets violations increase, and drones should instead help bring illegal activity to prosecutors' attention"]),
    "FAA-2026-4558-1200": ("utility_water_energy", "support_with_changes", ["ISO/RTO grid operator recommends Special (not just Standard) UAFRs for control centers given bulk-electric-grid reliability and national-security stakes", "Requests 24/7/365 permanent designations rather than time-limited restrictions", "Requests boundaries cover the full regional control-center footprint plus buffer, with strict Remote ID broadcast conditions on any authorized exceptions"]),
    "FAA-2026-4558-1219": ("individual_other", "support_with_changes", ["Former DOI Office of Aviation Services director draws on the 2017 FAA-DOI J-SOP (the first UAS-specific 14 CFR 99.7 restricted-airspace framework) as a proven model", "Recommends preserving explicit access pathways for public safety, wildfire response, CI inspection, and BVLOS Part 108 operations within UAFRs", "Recommends facility-level points of contact, standardized digital coordination (ADSP/UTM), and biannual reporting/trend-analysis requirements"]),
    "FAA-2026-4558-1232": ("media_photography", "oppose", ["Animal-cruelty investigation nonprofit relies on drone photo/video evidence to support criminal-investigation and enforcement complaints", "Notes FAA itself couldn't identify an agriculture facility not already covered by another sector or reaching national-level impact", "Argues the advance-notice-to-facility requirement lets facilities conceal conditions before investigators arrive, burdening anonymous speech and newsgathering"]),
    "FAA-2026-4558-1240": ("critical_infrastructure_owner", "support", ["Boston-area data center operator serving government, healthcare, financial, and telecom tenants", "Cites a growing number of drone-enabled surveillance/reconnaissance security concerns across the critical-infrastructure industry", "Urges FAA to finalize the rule and ensure data centers/telecom facilities are included among eligible facilities"]),
    "FAA-2026-4558-1211": ("other", "oppose", ["Argues factory farms emit 30-55x the ammonia (a PM2.5 precursor) the EPA treats as a regulatory limit for other industries, unmonitored by EPA", "Argues non-governmental airborne monitoring is needed to alert the public to respiratory risks since it wouldn't affect farm operations", "Frames the rule as helping conceal environmental-harm information from the public"]),
}
