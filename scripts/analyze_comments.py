...
CURATED = {
    ...
    "FAA-2026-4558-0554": ("government_agency", "unclear", ["State energy officials association filing; extracted text captured only the submission title, not the substantive body — needs manual follow-up against the source PDF"]),
...
def main():
    ...
    flags = [
        ...
        {"severity": "low", "title": "Comment-period extension requested",
